...
class _ShellTabPaneState extends State<ShellTabPane>
  ...
  /// 每个 Tab 独立主键滚动，避免 Stack 内多个 ListView 抢同一 PrimaryScrollController。
  late final ScrollController _primaryScroll;

  @override
  void initState() {
    super.initState();
    _primaryScroll = ScrollController();
